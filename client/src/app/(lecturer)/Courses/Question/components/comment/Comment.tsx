import { updateAnswer } from '@/apis/answer.lesson.apis';
...
export const Comment = ({ answer, handleVote }: { answer: answerLesson, handleVote: (answer: answerLesson, star: number) => void }) => {
