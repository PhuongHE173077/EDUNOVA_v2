export const FormMail = (webName, email, webUrl, password) => {
  return `
    <div style="font-family: 'Arial', sans-serif; border: 1px solid #e0e0e0; border-radius: 8px; padding: 30px; max-width: 500px; margin: 40px auto; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.05); background-color: #f9f9f9;">
      <h2 style="color: #333; text-align: center; margin-bottom: 25px; font-weight: 600;">
        <span style="color: #007bff;">${webName}</span> - Account Information
      </h2>

      <p style="font-size: 16px; color: #555; line-height: 1.6; margin-bottom: 20px;">
        Welcome to <span style="font-weight: bold; color: #007bff;">${webName}</span>! We've created a new account for you. Below are your login details. For security reasons, please reset your password using the link below.
      </p>
      ...
      <p style="font-size: 14px; color: #777; line-height: 1.5; text-align: center;">
        If you didn’t request this email, you can safely ignore it. The password reset link is valid for a limited time.
      </p>
